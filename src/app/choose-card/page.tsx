...
function ChooseCardPage() {
  return (
    <>
      {/* TODO: refactor top bar (create layout/compound components) */}
      <div className="relative mx-auto min-h-dvh max-w-[485px] border border-white bg-[#e4e4e4] p-5">
            ...
            {cards.map((card) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-4 z-0">
                  <span
                    className={cn(
                      "text-[clamp(120px,20vw,140px)] font-bold leading-none",
                      "isometric-text",
                    )}
        ...
        {/*  TODO: refactor fixed bottom bar (create layout/compound components) */}
        <div className="fixed bottom-5 left-1/2 w-fit -translate-x-1/2">
          <button
